...
- We created a bespoke Typescript library to render assets
...
- Less frequent timeouts, due to an improvement to 8base that limits the writing of data to both staging and main
...
- **Now, no more showing `str` instead of `byte`, or vice versa:** certain type misalignments are fixed.
