...
You can now clearly distinguish the **Log-in flow, authenticated flows, and unauthenticated flows** too, with handy tags in an individual user story. **All user stories have videos generated automatically**, and playable directly from the _Recordings_ table.
