...
You can now also clearly distinguish the **log-in flow, authenticated flows,** and unauthenticated flows too, with handy tags that are automatically added to an individual user story. Videos are also now **generated automatically for all User Stories**, and playable directly from the _Recordings_ table.
