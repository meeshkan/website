...
- **OpenAPI location**: The path or endpoint to your repository's *OpenAPI specification*.
- **GraphQL endpoint**: The path or endpoint to your repository's *GraphQL schema*. 
