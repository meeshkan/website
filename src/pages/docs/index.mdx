...
Meeshkan runs [property-based tests](/docs/how-meeshkan-works/#what-is-property-based-testing) on your repository and reports any bugs discovered in the process.
