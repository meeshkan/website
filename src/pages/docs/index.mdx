...
Here's what that'll look like if you substitute `Unmock` your organization name:
...
When Meeshkan finds a bug, the GitHub bot will post an issue to your repository and tag whoever installed Meeshkan. This issue will outline which command found the bug, the response, and, in some cases, a suggestion for how to resolve it.
