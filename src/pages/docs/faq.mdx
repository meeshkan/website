...
It's not a replacement for traditional techniques, but we're fans of property-based testing because it excels [where example-based testing lacks](/blog/property-based-testing-guide/#limitations-of-example-based-testing).

If you're interested in learning more, we've published a [beginner's guide to property-based testing](/blog/property-based-testing-guide/) on our blog.
