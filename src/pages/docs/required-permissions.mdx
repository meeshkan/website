...
To report bugs and issues, Meeshkan uses [a variety of channels](/how-meeshkan-works/#reporting-bugs-and-issues). One of these channels is posting GitHub issues on the registered repository. Here's [an example issue filed by Meeshkan](https://github.com/labsai/EDDI/issues/217) for reference.
