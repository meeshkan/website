...
- **Use dependency injection**: Refactor code so that there are very few top-level `require` statements. Instead, inject an environment into your functions. While this will still require some form of gating between test and other environments, it limits the gating to one place.
