...
...QA engineers can't find _all_ the corner cases. A lot of times, even with detailed instructions, it's not possible to describe all the ins and outs of your app using prose. What if, instead of or in addition to manual QA, you described these ins and outs _in code_. The _code_ part is important - you write a little robot that interacts with your app like a human would based on the properties an app should have. Ie "when I call endpoint X with data Y, I expect outcome Z".
