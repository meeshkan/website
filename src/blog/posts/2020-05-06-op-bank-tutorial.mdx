...
This should create a file in the generated `logs` directory called `sandbox.apis.op-palvelut.fi-recordings.jsonl`. This contains recordings in the [`http-types` format](/blog/introducing-http-types/).
