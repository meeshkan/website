...
Voilà [plzwrk](https://github.com/meeshkan/plzwrk). I've used it to build a couple [toy websites](https://github.com/meeshkan/plzwrk) and I must say the process has been quite delightful! Here, I'd like to present a brief overview of plzwrk. If you're a frontend dev, I hope you give it a try!
