...
slug: quick-check-state-machine
date: 2020-04-17
authors: ["mike"]
published: true
twitterShareUrl: https://twitter.com/intent/tweet?text=Stateful%20property-based%20testing%20with%20QuickCheck%20State%20Machine%20via%20%40meeshkan%20https%3A%2F%2Fmeeshkan.com%2Fblog%2Fquick-check-state-machine%2F
linkedinShareUrl: https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fmeeshkan.com%2Fblog%2Fquick-check-state-machine%2F&source=Meeshkan
tags:
  - testing
  - tutorial
  - advanced
...
**Stateful property-based testing (SPBT)** is another technique for when the tested system retains a state. This is the case, for example, when the system is a database or a queue or a file. If I write an entry to a database and then list all entries in the database, I would expect the entry I wrote to be part of the list. That is a _stateful_ property of the database.
...
1. It can test the parallel execution of commands to find bugs arising from race conditions.
