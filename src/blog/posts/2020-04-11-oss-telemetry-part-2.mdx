...
Developing your own telemetry feature will take more effort (time, money, maintenence) all around. But it also allows you to manage who has access to the data, what exactly is collected and how it is communicated to your users.
