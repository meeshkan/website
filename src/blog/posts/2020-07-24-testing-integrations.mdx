...
import { Box, Flex, FormControl, Input, Button } from "@chakra-ui/core"
...
Sound good? Request beta access today ⬇️
...
>
  ...
  <input type="hidden" name="form-name" value="request-beta-blog" />
  <Input
    type="email"
    name="email"
