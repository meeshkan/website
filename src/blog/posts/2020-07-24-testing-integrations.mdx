...
There are some libraries you can use to write your mocks. We recently published a post [comparing two JavaScript mocking libraries - nock and unmock](/blog/unmock-vs-nock/).
