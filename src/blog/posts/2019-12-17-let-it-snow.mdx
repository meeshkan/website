...
date: 2019-12-26
published: true
twitterShareUrl: https://twitter.com/intent/tweet?text=Let%20it%20snow!%20via%20%40meeshkan%20https%3A%2F%2Fmeeshkan.com%2Fblog%2Flet-it-snow%2F
linkedinShareUrl: https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fmeeshkan.com%2Fblog%2Flet-it-snow%2F&source=Meeshkan
tags:
  - lilypond
  - scheme
  - vocalmusic
...
I've been arranging a lot of things over the past two years as the CEO of Meeshkan — meetups, obligatory insurances, flights, pizza deliveries. However, one thing I haven't gotten the chance to arrange much is music. Until now! This holiday season, I took the time to make a six-voice arrangement of _Let It Snow!_ by Sammy Cahn and Jule Styne. I have [open-sourced](https://github.com/meeshkan/let-it-snow) the [arrangement](https://github.com/Meeshkan/let-it-snow/releases/download/v0.0.0/let-it-snow.pdf) for folks to sing as they go caroling. In addition to a PDF, this project contains the [LilyPond markdown](https://github.com/Meeshkan/let-it-snow/blob/ebc4702e8f7cd1f6d3a80d4dc4fbab632ed56d77/let-it-snow.ly) and the small hack I wrote to get LilyPond to write swing rhythms correctly in the MIDI.
...
First, for anyone doing wholesale music manipulation in LilyPond, start by [repurposing the naturalizeMusic example on this page](http://lilypond.org/doc/v2.18/Documentation/notation/changing-multiple-pitches). I've copied it below as well. It is stable, well written, and provides a useful template for most tweaking you'll need to do on a score.
