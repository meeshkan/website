...
Mock is the only part of the `quickcheck-state-machine` API that I think needs a little love. It feels a bit hackish, but as it's pretty straightforward to generate garbage responses based on commands, it doesn't feel too burdensome.  
