...
authors: ["mike"]
published: true
slug: upgrade-graphql-testing-past-graphiql
tags:
  - testing
  - apis
  - graphql
...
All of the techniques that make the cut below take less than an hour to implement. As we like to brag a bit (can you blame us?) our solution will be one of them, but there are other ones too! They're all complementary, and we think you'll get a lot of milage out of them. Enjoy!
...
I've seen a lot of teams define very precise business outcomes and yet, when it comes time to represent these outcomes in a GraphQL API, they use a `String` instead of an `enum`. This leads to unnecessary validation burden. Let your GraphQL framework do the heavy lifting for you by using enums!
