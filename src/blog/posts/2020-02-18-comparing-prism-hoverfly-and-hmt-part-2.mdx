---
title: Comparing Prism, Hoverfly, and HMT - Part 2
description: An article comparing three mocking frameworks
slug: comparing-prism-hoverfly-and-hmt-part-2
authors: ["mike"]
date: 2020-02-18
published: true
twitterShareUrl: https://twitter.com/intent/tweet?text=Comparing%20Prism%2C%20Hoverfly%2C%20and%20HMT%20-%20Part%202%20via%20%40meeshkan%20https%3A%2F%2Fmeeshkan.com%2Fblog%2Fcomparing-prism-hoverfly-and-hmt-part-2%2F
linkedinShareUrl: https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fmeeshkan.com%2Fblog%2Fcomparing-prism-hoverfly-and-hmt-part-2%2F&source=Meeshkan
tags:
  - api
  - web
  - devops
...
_This is the second article of a two-part series comparing Prism, Hoverfly, and HMT. This article focuses on using all three tools to build a mock of the github API v3, whereas the [first article](https://dev.to/hmt/comparing-prism-hoverfly-and-hmt-part-1-27g6) focuses on a high level comparison of the tools._

![HMT team](https://cdn.filestackcontent.com/AZvPNtU2oRLCcNYkJFCAAz/resize=width:1000/https://dev-to-uploads.s3.amazonaws.com/i/2ek2wxex4koaks7v2msf.jpg)
_Team HMT busy building HMT._

In the [previous article](https://dev.to/hmt/comparing-prism-hoverfly-and-hmt-part-1-27g6), we saw how to create a Prism server from an OpenAPI spec. We also saw how Hoverfly can play back recordings of server traffic. Lastly, we saw how HMT blends OpenAPI specs and recordings into a mock server.
