---
title: Rolling your own profunctors
description: How to leverage a powerful concept to write great code
...
In short, a profunctor is something that has input and output.
