...
This means asking for explicit consent from users before sending any data to your system. In [our initial survey about telemetry in open source](/blog/oss-telemetry-part-1/), many developers mentioned that telemetry features should be opt-in only. They also said that users should know what's being tracking and not have that information hidden in a blog post or setting somewhere.
