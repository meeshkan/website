...
💻 The tests featured in this post are available in the [corresponding GitHub repository](https://github.com/meeshkan/property-based-testing-for-js-devs/blob/main/tests/getNumberIntl.test.js).
