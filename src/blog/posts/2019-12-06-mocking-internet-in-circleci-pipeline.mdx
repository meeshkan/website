...
slug: mocking-the-internet
authors: ["mike"]
date: 2019-12-06
published: true
twitterShareUrl: https://twitter.com/intent/tweet?text=Mocking%20the%20internet%20in%20a%20CircleCI%20pipeline%20via%20%40meeshkan%20https%3A%2F%2Fmeeshkan.com%2Fblog%2Fmocking-the-internet%2F
linkedinShareUrl: https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fmeeshkan.com%2Fblog%2Fmocking-the-internet%2F&source=Meeshkan
tags:
  - unmock
  - circleci
  - integrationtest
...
```javascript
// hello.test.js
const { default: unmock, transform, runner, u } = require("unmock")
